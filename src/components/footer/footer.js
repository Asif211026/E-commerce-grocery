                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <br /><br />
                                <p>Grocery makes your day easy to Orders</p>
                                <br />

                                <p><LocationOnOutlinedIcon /> <strong>Address</strong>: Sistec-E,Sikandarabad,Ratibad,Bhopal,M-P</p>
                                <p><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> (+91) - 9097902763 </p>
                                <p><EmailOutlinedIcon /> <strong>Email:</strong> apna@dukan.com</p>
                                ...
                                <div className='m-auto d-flex align-items-center phWrap'>
                                    <div className='phNo d-flex align-items-center mx-5'>
                                        ...
                                        <div className='info ml-3'>
                                            <h3 className='text-g mb-0'>+91-9097902763</h3>
